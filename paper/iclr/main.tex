...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% ICLR 2027 version -- transposed verbatim from the NLDL version
% (paper/NLDL/main.tex) into the ICLR 2027 conference format.
% Build: pdflatex main && bibtex main && pdflatex main && pdflatex main
% Uncomment \iclrfinalcopy below for the camera-ready version only.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\documentclass{article} % For LaTeX2e
\usepackage{iclr2027_conference,times}

% Optional math commands from https://github.com/goodfeli/dlbook_notation
% (shipped with the template; not needed by this paper).
...
% Figures
\usepackage{graphicx}
% Shared historical figures live in paper/neurips/figures/.
\graphicspath{{./}{../}{../neurips/figures/}}
...
%% Abbreviations (provided by nldl.cls in the NLDL version)
\usepackage{xspace}
\makeatletter
...
\def\wrt{w.r.t\onedot} \def\etal{et al\onedot}
\makeatother
...
% TODO(author): the source cited \ref{appendix:bert}, a label that exists
% nowhere in paper.tex, so it rendered as "??". Repointed to the appendix
% that actually carries the BERT LoRA configuration (Table~\ref{tab:bert_config}
% lives there). Confirm this is the intended target.
\item \textbf{BERT-base:} 110M parameters, fine-tuned with LoRA following Appendix~\ref{appendix:training}; 20 epochs, batch size 32.
\end{itemize}
...
\begin{subfigure}[t]{0.48\textwidth}
    \centering
    \figureorplaceholder{BERT.png}{BERT per-layer attention summary.}
    \caption{BERT-base.}
\end{subfigure}
\hfill
\begin{subfigure}[t]{0.48\textwidth}
    \centering
    \figureorplaceholder{Llama.png}{Llama per-layer attention summary.}
