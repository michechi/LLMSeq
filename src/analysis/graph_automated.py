...
models = ["emilyalsentzer/Bio_ClinicalBERT", "meta-llama/Llama-3.1-8B", "answerdotai/ModernBERT-large", "Charangan/MedBERT"]
prompts = ["no", "naive", "full_no_time", "compact_no_time", "compact", "compact_narrative", "full"]
