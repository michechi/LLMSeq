...
def _parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--anchor_ell", type=int, default=2, help="Anchor alphabet size (2 or 4)")
...
def main() -> None:
    ...
    if args.build_anchor:
        n_keys = args.anchor_k if args.anchor_k is not None else max(1, args.anchor_ell // 2)
        build_binary_anchor(
            output_dir=args.output_dir,
            alphabet_size=args.anchor_ell,
            n_keys=n_keys,
            seed=args.seed,
        )
