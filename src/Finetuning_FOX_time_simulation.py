...
from transformers import (
    AutoTokenizer, AutoModelForSequenceClassification, get_linear_schedule_with_warmup, BitsAndBytesConfig, AutoModelForCausalLM, AutoConfig
)
...
def parse_args(args=None):
    ...
    # Data
    ## Train
    parser.add_argument("--X_train_csv", type=str, default="/fp/homes01/u01/ec-michelec/MIMICIV/data/simulation/X_train_12.csv",
                        help="Path to file CSV di training")
    
    parser.add_argument("--y_train_csv", type=str, default="/fp/homes01/u01/ec-michelec/MIMICIV/data/simulation/y_train_12.csv",
                        help="Path to file CSV di training")
    ## Val
    parser.add_argument("--X_val_csv", type=str, default="/fp/homes01/u01/ec-michelec/MIMICIV/data/simulation/X_val_12.csv",
                        help="Path to file CSV di validation")
    
    parser.add_argument("--y_val_csv", type=str, default="/fp/homes01/u01/ec-michelec/MIMICIV/data/simulation/y_val_12.csv",
                        help="Path to file CSV di training")
    ## Test
    parser.add_argument("--X_test_csv", type=str, default="/fp/homes01/u01/ec-michelec/MIMICIV/data/simulation/X_test_12.csv",
                        help="Path to file CSV di validation")
    
    parser.add_argument("--y_test_csv", type=str, default="/fp/homes01/u01/ec-michelec/MIMICIV/data/simulation/y_test_12.csv",
                        help="Path to file CSV di training")
    ...
    parser.add_argument("--cold_start", action="store_true",
                        help="If set, do not load any pre-trained weights (random initialization)")
...
def shuffle_sequence(sequence, to_split='\x1f'):
    events = sequence.split(to_split)
    random.shuffle(events)
    return to_split.join(events)
