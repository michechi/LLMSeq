...
def parse_args(args=None):
    ...
    # Data
    ## Train
    parser.add_argument("--X_train_csv", type=str, default="/root/MIMICIV/data/simulation/X_train_9_med.csv",
                        help="Path to file CSV di training")
    
    parser.add_argument("--y_train_csv", type=str, default="/root/MIMICIV/data/simulation/y_train_9_med.csv",
                        help="Path to file CSV di training")
    ## Val
    parser.add_argument("--X_val_csv", type=str, default="/root/MIMICIV/data/simulation/X_val_9_med.csv",
                        help="Path to file CSV di validation")
    
    parser.add_argument("--y_val_csv", type=str, default="/root/MIMICIV/data/simulation/y_val_9_med.csv",
                        help="Path to file CSV di training")
    ## Test
    parser.add_argument("--X_test_csv", type=str, default="/root/MIMICIV/data/simulation/X_test_9_med.csv",
                        help="Path to file CSV di validation")
    
    parser.add_argument("--y_test_csv", type=str, default="/root/MIMICIV/data/simulation/y_test_9_med.csv",
                        help="Path to file CSV di training")
