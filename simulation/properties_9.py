...
if generate:
    ...
    sequences = pd.read_csv("/root/MIMICIV/data/simulation/X_test_5.csv")["Sequences"].tolist()
    labels = pd.read_csv("/root/MIMICIV/data/simulation/y_test_5.csv")["Outcome"].tolist()

    sequences += pd.read_csv("/root/MIMICIV/data/simulation/X_train_5.csv")["Sequences"].tolist()
    labels += pd.read_csv("/root/MIMICIV/data/simulation/y_train_5.csv")["Outcome"].tolist()

    sequences += pd.read_csv("/root/MIMICIV/data/simulation/X_val_5.csv")["Sequences"].tolist()
    labels += pd.read_csv("/root/MIMICIV/data/simulation/y_val_5.csv")["Outcome"].tolist()
