...
[Cleanup notes](docs/repository_cleanup.md) explain what was removed from the tracked tree and how it is preserved. The original checkout and Git history are unchanged. Old history still requires separate attention before this repository can be considered cleared of previously tracked clinical files and credentials.
